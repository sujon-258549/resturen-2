...
const Footer = () => {
    return (
        <div>
            <section className='bg-gradient-to-r from-slate-900 via-slate-700 to-slate-900 py-10 px-10 font-sans tracking-wide'>
                <div className='main_container'>
                    <footer className="">
                        <div className="max-w-2xl mx-auto text-center">
                            <a href="javascript:void(0)" className="inline-block">
                                <a href="javascript:void(0)">
                                    <img src="https://takumibd.com/assets/front/img/624921a7199ec.jpg" alt="logo" className='w-20 rounded-full' />
                                </a>
                            </a>
